<%-- 
    Document   : new_discount
    Created on : Feb 24, 2014, 11:00:18 AM
    Author     : Liam
--%>
            ...
            $.ajax({
                ...
                success: function(data) {
                    var highlight="<div class='ui-state-highlight ui-corner-all' style='margin-top: 20px; padding: 0 .7em;'>"
                        ...
                        +"<strong>Descuento creado</strong> Codigo "+data.id+"</p>"
                        +"</div>";
...
<form id="form_<%out.print(id);%>"  action="#" method="POST">
    ...
    <input class="text_input" type="text" name="percentage"  placeholder="Porcentage" /><br/>
