<%-- 
    Document   : new_shipping_method
    Created on : Feb 25, 2014, 4:42:49 PM
    Author     : Liam
--%>
...
<script>    
    $(document).ready(function(){
        ...
        $("#form_<%out.print(id);%>").submit(function(e) {
            ...
            $.ajax({
                url: "ShippingMethodServiceInsert",
                type: "POST",
                data: formFiels,
                dataType: "json",
                success: function(data) {
                    var highlight="<div class='ui-state-highlight ui-corner-all' style='margin-top: 20px; padding: 0 .7em;'>"
                        ...
                        +"<strong>Forma de envio creada</strong> Codigo "+data.id+"</p>"
                        +"</div>";
...
<form class="form_<%out.print(id);%>" action="#" method="POST">
